...
import '../Profile-Creation/profile_creation2.dart';
import '../settings/settings.dart';

class ProfileDiscount extends StatelessWidget {
  const ProfileDiscount({Key? key}) : super(key: key);
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  height: MediaQuery.of(context).size.height * 0.8, // Fixed height based on screen size
                                ...
                                Container(
                                  ...
                                  child: ElevatedButton(
                                    style: ElevatedButton.styleFrom(
                                      backgroundColor: const Color(0xffF0E8DC), // Beige color
                                      elevation: 0,
                                      shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.circular(25),
                                        side: const BorderSide(
                                          color: Colors.black,
                                          width: 2.0, // Slightly thicker border to match image
                                        ),
                                      ),
