...
class _HotelDetailScreenState extends State<HotelDetailScreen> {
  bool isLiked = false;
  int currentBottomNavIndex = 1; // Set to Newsletter tab since this is detail content
        ...
        child: Column(
          children: [
            ...
            Expanded(
              ...
              decoration: BoxDecoration(
                color: const Color(0xFFEADBC8), // light beige background
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color(0xFF1361E0), // Blue button
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              image: AssetImage("assets/images/Rectangle 121.png"),
            ),
          ),
          child: Center(
            child: Text(
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _buildHourRow1('Sunday', 'closed'),
                    const SizedBox(height: 8),
                    _buildHourRow('Monday', '11:00AM - 11:30PM'),
                    const SizedBox(height: 8),
                    _buildHourRow('Tuesday', '11:00AM - 11:30PM'),
                    const SizedBox(height: 8),
                    _buildHourRow('Wednesday', '11:00AM - 11:30PM'),
                    const SizedBox(height: 8),
                    _buildHourRow('Thursday', '11:00AM - 11:30PM'),
                    const SizedBox(height: 8),
                    _buildHourRow('Friday', '1:00PM - 12:00AM'),
                    const SizedBox(height: 8),
                    _buildHourRow('Saturday', '1:00PM - 12:00AM'),
                  ],
                ),
              ),
            ],
