...
class MatchProfileView extends GetView<MatchProfileController> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<MatchProfileController>(
      init: MatchProfileController(),
      builder: (controller) {
        return Scaffold(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: Colors
                                  .grey[300], // Background color for the icon
                            ),
                            clipBehavior: Clip.hardEdge,
                            child:
                                controller.profileModel?.profilePhoto != null &&
                                    controller
                                        .profileModel!
                                        .profilePhoto!
                                        .isNotEmpty
                                ? Image.network(
                                    controller.profileModel?.profilePhoto ?? '',
                                    fit: BoxFit.cover,
                      ...
                      Column(
                        ...
                        children: [
                          _buildProfileRow(
                            'Nationality',
                            controller.profileModel?.location ?? '',
                          ),
                            ...
                            children: [
                              Expanded(
                                child: _buildProfileDetail(
                                  'Age',
                                  controller.profileModel!.age.toString(),
                                ),
                              ),
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: _buildProfileDetail(
                                  'Status',
                                  controller.profileModel?.maritalStatus ?? '',
                                ),
                              ),
                            ],
                          ),
