...
class SlideToRedeem extends StatefulWidget {
  const SlideToRedeem({super.key});

  @override
  State<SlideToRedeem> createState() => _SlideToRedeemState();
}

class _SlideToRedeemState extends State<SlideToRedeem> {
