...
class VerificationDatingScreen extends StatefulWidget {
  const VerificationDatingScreen({super.key});

  @override
  State<VerificationDatingScreen> createState() =>
      _VerificationDatingScreenState();
}

class _VerificationDatingScreenState extends State<VerificationDatingScreen> {
  @override
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: RichText(
                          ...
                          text: TextSpan(
                            text:
                                "We believe in matching people through their inner beauty, while ensuring every interaction is",
                            style: TextStyle(
                              fontSize: 17.sp,
                              color: Colors.black54,
                              fontWeight: FontWeight.w700,
                      ...
                      Text(
                        "Once you're in, you’ll explore and connect through avatars, pseudonyms, and authentic conversations.Ready to get started?",
                        style: TextStyle(
                          fontSize: 14.sp,
                          color: Colors.black54,
                          fontWeight: FontWeight.w700,
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Center(
                child: Image.asset(
                  "assets/images/singpass/singpass_logo_fullcolours-2.png",
                ),
              ),
            ),
                    ...
                    children: [
                      ...
                      Center(
                        child: RichText(
                          text: TextSpan(
                            text:
                                'Clicking "I Agree" button permit the teacher\'s service to receive your data based on the',
                            style: TextStyle(
